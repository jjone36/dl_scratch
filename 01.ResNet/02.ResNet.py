...
class ResNet:
    ...
    def __init__(self, ):
        self.layer = [# Conv1
                      ...
                      MaxPoolLayer(dims = 3)
                      # Conv2
                      ConvBlock(mi = 64, fm_sizes= [64, 64, 256], strides = 1),
                      IdentityBlock(mi = 256, fm_sizes= [64, 64, 256]),
                      IdentityBlock(mi = 256, fm_sizes= [64, 64, 256]),
                      # Conv3
                      ConvBlock(mi = 256, fm_sizes= [128, 128, 512], strides = 2),
                      IdentityBlock(mi = 512, fm_sizes= [128, 128, 512]),
                      IdentityBlock(mi = 512, fm_sizes= [128, 128, 512]),
                      IdentityBlock(mi = 512, fm_sizes= [128, 128, 512]),
                      # Conv4
                      ConvBlock(mi = 512, fm_sizes= [256, 256, 1024], strides = 2),
                      ...
                      IdentityBlock(mi = 1024, fm_sizes= [256, 256, 1024])
                      # Conv5
                      ConvBlock(mi = 1024, fm_sizes= [512, 512, 2048], strides = 2),
